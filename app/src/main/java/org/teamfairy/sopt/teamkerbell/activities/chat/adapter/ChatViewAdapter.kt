...
import org.teamfairy.sopt.teamkerbell.activities.chat.viewholder.*
        ...
        when (data.type) {
            ChatUtils.TYPE_MESSAGE -> {
                if (data.isSender(mContext)) {
                    ...
                    requestHolder.content.background = if (data.chat_idx == pickIdx)
                        ContextCompat.getDrawable(mContext, R.drawable.shape_round_btn_chat_pick)
                    else
                        ContextCompat.getDrawable(mContext, R.drawable.img_chat_balloon)
                } else {
                    ...
                    receiveHolder.content.background = if (data.chat_idx == pickIdx)
                        ContextCompat.getDrawable(mContext, R.drawable.shape_round_btn_chat_pick)
                    else
                        ContextCompat.getDrawable(mContext, R.drawable.img_chat_balloon_left)
                }
            }
